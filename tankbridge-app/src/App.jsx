        ...
        <>
          ...
          <section style={{ padding: "40px 0 8px" }}>
            ...
            <div className="gnt-card" style={{ fontSize: 12.5, color: "var(--steel)", lineHeight: 1.6 }}>
              ...
              Tankbridge acts solely as an introducing intermediary and is not a party to any resulting sale, purchase, or delivery agreement. Tankbridge makes no representation or warranty as to quality, quantity, title, deliverability, or any counterparty's ability to perform. Any dispute is strictly between the buyer and seller involved. Tankbridge does not hold, transmit, or have custody of any transaction or commission funds — settlement is handled directly between the parties via an independent third-party escrow. To the fullest extent permitted by South African law, Tankbridge's liability is limited to any brokerage fee actually received in respect of the transaction giving rise to the claim. Users should seek independent legal and commercial advice before entering into any transaction.
            </div>
          </section>
